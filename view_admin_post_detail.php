...
$postId = $_GET['post_id'];  // Ensure 'post_id' is passed in the query string

// Include the database connection
include("db_connection.php");

// Fetch post details from `admin_posts`
$postQuery = "SELECT * FROM admin_posts WHERE post_id = ?";
...
// Fetch images related to the post from `admin_post_images`
$imageQuery = "SELECT * FROM admin_post_images WHERE post_id = ?";
...
if (isset($_POST['login'])) {
    ...
    header("Location:view_admin_post_detail.php?error_message=" . urlencode($error_message) . "&post_id=" . $_GET['post_id']);
    exit;
}
    ...
    <div class="post-container">
        ...
        <div class="image-grid">
            <?php while ($image = $imageResult->fetch_assoc()): ?>
                <img src="uploads/<?php echo htmlspecialchars($image['image_name']); ?>" alt="Post Image" class="gallery-image" onclick="openModal(this)">
            <?php endwhile; ?>
        </div>
...
<button class="btn-comment" onclick="openLoginModal('<?php echo $_GET['post_id']; ?>')">Comments</button>
...
if (isset($_GET['error_message'])) {
    ...
    echo "<script>openLoginModal('".$_GET['post_id']."');</script>";
}
?>
